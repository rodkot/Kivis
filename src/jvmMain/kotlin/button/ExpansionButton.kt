...
import ru.nsu.ccfit.kivis.tool.ExpansionTool
import ru.nsu.ccfit.kivis.tool.Tool

class ExpansionButton (private val currentTool: MutableState<Tool>) : Button() {
    private val name: String = ExpansionTool.name
